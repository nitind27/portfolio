  ...
  return (
    <>
      <a
        ...
        className="w-full flex items-center justify-center gap-2.5 py-2.5 rounded-xl text-sm font-semibold border transition hover:bg-white/[0.06]"
      ...
      <div className="flex items-center gap-3 my-4">
        ...
        <span className="text-[10px] text-gray-600 uppercase tracking-wide">or email</span>
        <div className="flex-1 h-px" style={{ background: brand.border }} />
      </div>
    </>
  );
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4" style={{ background: brand.bg }}>
      ...
      >
        ...
        <div className="p-6">
          <AuthForm mode={mode} setMode={setMode} onClose={onClose} formId={formId} />
        </div>
      </motion.div>
    </div>
  );
